...
import { CheckCircle2, Target, History, Users, ShieldCheck, Award } from "lucide-react";
    ...
    <div className="bg-white">
      ...
      <section className="bg-primary-dark py-20 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-gray-300 text-center max-w-3xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="200">
            أكثر من 25 عاماً من الخبرة والتميز في توريد وتركيب وصيانة المصاعد والسلالم الكهربائية في السوق المصري.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2" data-aos="fade-left">
              <h2 className="text-3xl font-bold text-primary-dark mb-6">قصة نجاحنا</h2>
              <div className="space-y-4 text-gray-600 leading-relaxed text-lg text-justify">
                <p>
                  تأسست شركة مصر الخليج (EGGEEC) برؤية واضحة لتغيير مفهوم التنقل الرأسي في مصر. على مدار عقدين، نجحنا في بناء اسم موثوق يجمع بين الخبرة المحلية والتقنيات العالمية.
                </p>
                <p>
                  بدأنا بمجموعة صغيرة من المهندسين المتميزين، واليوم نفخر بامتلاكنا لواحدة من أكبر فرق الدعم الفني والتركيبات في مصر، مع سجل حافل بالمشاريع القومية والتجارية الكبرى.
                </p>
              </div>
            </div>
            <div className="md:w-1/2 grid grid-cols-2 gap-4" data-aos="fade-right">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-primary-dark mb-16" data-aos="fade-up">قيمنا الجوهرية</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((val, idx) => (
              <div key={idx} className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-xl transition-shadow border-b-4 border-secondary-gold" data-aos="fade-up" data-aos-delay={idx * 150}>
                <val.icon className="h-12 w-12 text-secondary-gold mb-6" />
                <h3 className="text-2xl font-bold text-primary-dark mb-4">{val.title}</h3>
